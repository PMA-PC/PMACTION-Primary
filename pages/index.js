    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-white to-teal-50 p-4">
      <main className="text-center p-8 md:p-12 bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl max-w-4xl w-full border border-white/50">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-6 leading-tight drop-shadow-sm">
          ...
          <span className="block text-2xl md:text-3xl mt-2 font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
        ...
        <div className="border-t border-gray-100 pt-8 mt-8">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-700 mt-4 leading-tight">
            One <span className="text-emerald-600">Action</span> at a Time.
          </h2>
        </div>
      </main>
    </div>
